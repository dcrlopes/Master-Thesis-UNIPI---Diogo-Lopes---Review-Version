...
%  Values read from the simulation repository, whose branch and commit
%  are recorded in Appendix B. Formulas are given in the main text.
% =====================================================================
...
from the simulation repository, in the state that
Appendix~\ref{app:code-architecture} records with its branch and its
commit. The codes of the tables are given

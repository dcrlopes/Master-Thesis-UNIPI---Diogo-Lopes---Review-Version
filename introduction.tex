...
\begin{itemize}
  \item A parametric OpenMC model of the core, made by 32 assembly at 
...
iteration, NSGA-II samples the Gaussian-process surrogate, and from the
candidate designs, it selects a small batch, six configurations in this work, 
where the surrogate is most uncertain and runs them in OpenMC
...
a set of candidate core configurations for LABGENE, from which the final
design can be selected from the Pareto front.
